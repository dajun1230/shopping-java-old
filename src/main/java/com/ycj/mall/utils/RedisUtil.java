...
public class RedisUtil {
    ...
    public Long addGeoPoin(Object k, Point point, Object m) {
        Long addedNum = redisTemplate.opsForGeo().geoAdd((String) k, point, m);
        return addedNum;
    }
    ...
    public List<Point> geoGet(Object k, Object... m) {
        List<Point> points = redisTemplate.opsForGeo().geoPos((String)k, m);
        return points;
    }
    ...
    public Distance geoDist(Object k, Object mk1, Object mk2, Metric metric) {
        Distance distance = redisTemplate.opsForGeo().geoDist((String) k, mk1, mk2, metric);
        return distance;
    }
    ...
    public GeoResults nearByXY(Object k, Circle circle, RedisGeoCommands.GeoRadiusCommandArgs args) {
        ...
        GeoResults<RedisGeoCommands.GeoLocation<Object>> results = redisTemplate.opsForGeo().geoRadius((String) k, circle, args);
        return results;
//        System.out.println(results);
    ...
    public GeoResults nearByPlace(Object k, Object mk, Distance distance, RedisGeoCommands.GeoRadiusCommandArgs args) {
        GeoResults<RedisGeoCommands.GeoLocation<Object>> results = redisTemplate.opsForGeo().geoRadiusByMember((String) k, mk, distance, args);
        return results;
    }
    ...
    public List geoHash(Object k, Object... mks) {
        List<String> results = redisTemplate.opsForGeo().geoHash((String) k, mks);
        return results;
    }
